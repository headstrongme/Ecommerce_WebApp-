<%-- 
    Document   : DeleteRegRep
    Created on : 9 Jun, 2017, 11:26:56 PM
    Author     : Dell
--%>
        ...
        <form action='Delete.jsp' method='post'>  
            <center>  
                <table border='2' cellspacing='5' style='text-align:center'>  
                    ...
                    <tr>  
                        <td>  
                            <input type='radio' name='delete' value='<%=rs.getString(2)%>'>  
                        </td>  
                        <td>  
                            <%=rs.getString(1)%>      
                        </td>  
                ...
                <br>  
                <input type='submit' name='submit' value='Delete Selected Record'>  
                </form>  
            </center>  
    </body>
    <%
